...
const genreList = {
    ...
    function({genres}){
        ...
        fetchDataFromServer(`https://api.themoviedb.org/3/movie/popular?api_key=a5e6eb43e57de6279ab1313d2e104850&page=1`, 
        heroBanner)
    })
    ...
    banner.ariaLabel = "pPopular Movies"
    ...
    for (const { title, path} of homePageSections){
        fetchDataFromServer(`https://api.themoviedb.org/3${path}?api_key=a5e6eb43e57de6279ab1313d2e104850&page=1`, 
